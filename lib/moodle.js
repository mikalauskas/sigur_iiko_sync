...
const addUserToCohort = async (user = {}, incomingUser = {}, cohort = {}) => {
  ...
  switch (incomingUser.edu_form) {
    case 'Очно-заочная':
      ...
      addCohortMembersData['members[1][cohorttype][value]'] = USK_MOODLE_GROUP_ID;
      addCohortMembersData['members[1][usertype][type]'] = 'id';
      addCohortMembersData['members[1][usertype][value]'] = user.id;
      break;
    case 'Заочная':
      addCohortMembersData['members[1][cohorttype][type]'] = 'id';
      addCohortMembersData['members[1][cohorttype][value]'] = ZAOCH_MOODLE_GROUP_ID;
      addCohortMembersData['members[1][usertype][type]'] = 'id';
      addCohortMembersData['members[1][usertype][value]'] = user.id;
      break;
    case 'Очная':
      addCohortMembersData['members[1][cohorttype][type]'] = 'id';
      addCohortMembersData['members[1][cohorttype][value]'] = SPO_MOODLE_GROUP_ID;
      addCohortMembersData['members[1][usertype][type]'] = 'id';
      addCohortMembersData['members[1][usertype][value]'] = user.id;
      break;
  }
  ...
  switch (incomingUser.speciality_name) {
    case 'Фармация':
      ...
      addCohortMembersData['members[2][cohorttype][value]'] = FARMA_MOODLE_GROUP_ID;
      addCohortMembersData['members[2][usertype][type]'] = 'id';
      addCohortMembersData['members[2][usertype][value]'] = user.id;
      break;
    case 'Лечебное дело':
      addCohortMembersData['members[2][cohorttype][type]'] = 'id';
      addCohortMembersData['members[2][cohorttype][value]'] = LECH_MOODLE_GROUP_ID;
      addCohortMembersData['members[2][usertype][type]'] = 'id';
      addCohortMembersData['members[2][usertype][value]'] = user.id;
      break;
    case 'Сестринское дело':
      addCohortMembersData['members[2][cohorttype][type]'] = 'id';
      addCohortMembersData['members[2][cohorttype][value]'] = SESTR_MOODLE_GROUP_ID;
      addCohortMembersData['members[2][usertype][type]'] = 'id';
      addCohortMembersData['members[2][usertype][value]'] = user.id;
      break;
    case 'Медицинская оптика':
      addCohortMembersData['members[2][cohorttype][type]'] = 'id';
      addCohortMembersData['members[2][cohorttype][value]'] = OPTIC_MOODLE_GROUP_ID;
      addCohortMembersData['members[2][usertype][type]'] = 'id';
      addCohortMembersData['members[2][usertype][value]'] = user.id;
      break;
    case 'Стоматология профилактическая':
      addCohortMembersData['members[2][cohorttype][type]'] = 'id';
      addCohortMembersData['members[2][cohorttype][value]'] = STOM_MOODLE_GROUP_ID;
      addCohortMembersData['members[2][usertype][type]'] = 'id';
      addCohortMembersData['members[2][usertype][value]'] = user.id;
      break;
  }
...
const handleStudentUser = async (incomingUser, moodleUsers) => {
...
const syncMoodle = async (CUsers = []) => {
  ...
  try {
    ...
    for (const incomingUser of CStudents_valid) {
      await handleStudentUser(incomingUser, moodleUsers);
    }
