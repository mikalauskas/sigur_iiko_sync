...
const messageTemplates = (templateName, data) => {
  const templates = {
    createUser: `Для Вас создана учетная запись в Личном Кабинете UMED. Там вы можете посмотреть своё расписание, зачетную книжку, оценки и многое другое! Для входа пройдите по ссылке https://umedcollege.ru/lk Логин: ${data.LOGIN} Пароль: ${data.PASSWORD ? data.PASSWORD : 'СНИЛС без прочерков и пробелов (11 цифр)'}`,
    createParent: `Для Вас создана учетная запись в Личном Кабинете UMED. Там вы можете посмотреть расписание, зачетную книжку, оценки студента и многое другое! Для входа пройдите по ссылке https://umedcollege.ru/lk Логин: ${data.LOGIN} Пароль: ${data.PASSWORD ? data.PASSWORD : 'СНИЛС студента без прочерков и пробелов (11 цифр)'}`,
    updateUser: `Ваша учетная запись в Личном Кабинете UMED была изменена. Для входа пройдите по ссылке https://umedcollege.ru/lk Логин: ${data.LOGIN} Пароль: ${data.PASSWORD ? data.PASSWORD : 'СНИЛС без прочерков и пробелов (11 цифр)'}`,
    updateParent: `Ваша учетная запись в Личном Кабинете UMED была изменена. Для входа пройдите по ссылке https://umedcollege.ru/lk Логин: ${data.LOGIN} Пароль: ${data.PASSWORD ? data.PASSWORD : 'СНИЛС студента без прочерков и пробелов (11 цифр)'}`,
  };
